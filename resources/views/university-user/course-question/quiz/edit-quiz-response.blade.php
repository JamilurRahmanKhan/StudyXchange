...
@section('title','Edit Students Quiz Responses')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Edit Students Quiz Responses</li>
                </ol>
            </div>
                        ...
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                    ...
                                    <form action="{{ route('university-user.quiz.response.update', $assessmentResult->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
