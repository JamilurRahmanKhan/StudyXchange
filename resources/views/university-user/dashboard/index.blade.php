    ...
    <div class="content-body default-height">
        ...
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">University User Dashboard</h2>
            </div>
{{--            <div class="row">--}}
{{--                <div class="col-xl-6">--}}
{{--                    <div class="row">--}}
...
{{--                                <img src="{{asset('/')}}super-admin-assets/assets/images/card/card.png" alt="" class="mw-100">--}}
...
{{--                                        <img src="{{asset('/')}}super-admin-assets/assets/images/dual-dot.png" alt="" class="dot-img">--}}
...
{{--                                                <img src="{{asset('/')}}super-admin-assets/assets/images/avatar/1.jpg" alt="">--}}
...
{{--                                        <div class="item">--}}
{{--                                            <div class="image-bx mb-2">--}}
{{--                                                <img src="{{asset('/')}}super-admin-assets/assets/images/avatar/2.jpg" alt="">--}}
{{--                                                <i class="las la-check-circle"></i>--}}
{{--                                            </div>--}}
{{--                                            <h6 class="fs-16 mb-0"><a href="transactions-details.html"--}}
...
{{--                                        <div class="item">--}}
{{--                                            <div class="image-bx mb-2">--}}
{{--                                                <img src="{{asset('/')}}super-admin-assets/assets/images/avatar/3.jpg" alt="">--}}
{{--                                                <i class="las la-check-circle"></i>--}}
{{--                                            </div>--}}
{{--                                            <h6 class="fs-16 mb-0"><a href="transactions-details.html"--}}
...
{{--                                        <div class="item">--}}
{{--                                            <div class="image-bx mb-2">--}}
{{--                                                <img src="{{asset('/')}}super-admin-assets/assets/images/avatar/4.jpg" alt="">--}}
{{--                                                <i class="las la-check-circle"></i>--}}
{{--                                            </div>--}}
{{--                                            <h6 class="fs-16 mb-0"><a href="transactions-details.html"--}}
...
{{--                                        <div class="item">--}}
{{--                                            <div class="image-bx mb-2">--}}
{{--                                                <img src="{{asset('/')}}super-admin-assets/assets/images/avatar/5.jpg" alt="">--}}
{{--                                                <i class="las la-check-circle"></i>--}}
{{--                                            </div>--}}
{{--                                            <h6 class="fs-16 mb-0"><a href="transactions-details.html"--}}
...
{{--                                                    </td>--}}
{{--                                                    <td>--}}
{{--                                                        <h6 class="fs-16 text-black font-w400 mb-0">June 4, 2023--}}
{{--                                                        </h6>--}}
...
{{--                                                    </td>--}}
{{--                                                    <td>--}}
{{--                                                        <h6 class="fs-16 text-black font-w400 mb-0">June 5, 2023--}}
{{--                                                        </h6>--}}
{{--                                                        <span class="fs-14">05:34</span>--}}
{{--                                                    </td>--}}
