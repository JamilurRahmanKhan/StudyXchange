    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Edit University Courses</li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('university-user.course.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-xl-8">
                                <div class="card h-auto">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" class="form-control" placeholder="Question" value="{{ old('title', $course->title) }}">
                                            @error('title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="ckeditor">{{ old('description', $course->description) }}</textarea>
                                            @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
