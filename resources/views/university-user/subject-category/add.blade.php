...
@section('title','Add Subject Category')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Add Subject Category</li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
...
{{--                    <p class="alert-success">{{session('message')}}</p>--}}
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('university-user.subject-category.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-xl-8">
