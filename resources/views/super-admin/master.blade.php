...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="{{route('super-admin.dashboard')}}" class="brand-logo">
            <img class="logo-abbr" src="{{asset('/')}}super-admin-assets/assets/images/logo.png" alt="">
            <img class="logo-compact" src="{{asset('/')}}super-admin-assets/assets/images/logo-text.png" alt="">
            <img class="brand-title" src="{{asset('/')}}super-admin-assets/assets/images/logo-text.png" alt="">
        </a>
                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                ...
                                <img src="{{asset('/')}}super-admin-assets/assets/images/profile/17.jpg" width="20" alt="">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
...
{{--                        <li><a href="{{route('super-admin.category.create')}}">Add Category</a></li>--}}
{{--                        <li><a href="{{route('super-admin.category.index')}}">Manage Category</a></li>--}}
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
                    ...
                    <ul aria-expanded="false">
{{--                        <li><a href="{{route('super-admin.blog.create')}}">Add Blog</a></li>--}}
{{--                        <li><a href="{{route('super-admin.blog.index')}}">Manage Blog</a></li>--}}
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
                    ...
                    <ul aria-expanded="false">
{{--                        <li><a href="{{route('super-admin.user.index')}}">Manage User</a></li>--}}
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
                        <span class="nav-text">User verification</span>

                    </a>
                    <ul aria-expanded="false">
{{--                        <li><a href="{{route('super-admin.unverified-users')}}">Manage User</a></li>--}}
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
...
{{--                        <li><a href="{{route('about.index')}}">Manage About</a></li>--}}
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
...
{{--                        <li><a href="{{route('contact.index')}}">Manage Contact</a></li>--}}
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
{{--                        <li><a href="{{route('policy.create')}}">Add Privacy Policy</a></li>--}}
{{--                        <li><a href="{{route('policy.index')}}">Manage Privacy Policy</a></li>--}}
                    </ul>
                </li>
            </ul>
