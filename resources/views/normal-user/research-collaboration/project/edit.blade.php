    ...
    <div class="main">
        ...
        <div class="main-content project">
            <div class="row">
                <div class="col-12">
                    <div class="box">
                        <form action="{{ route('normal-user.research-project.update', $researchProject->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-24">
                                        <div class="form-group"> <label class="form-label">Project Title</label>
                                            <input class="form-control" name="title" value="{{ old('title', $researchProject->title) }}" placeholder="Project Title">
                                            @error('title')
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-24">
                                        <div class="form-group"> <label class="form-label">Department</label>
                                            <input class="form-control" name="department" value="{{ old('department', $researchProject->department) }}" placeholder="Department">
                                            @error('department')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 mb-24">
                                        <div class="form-group"> <label class="form-label">Project Objective</label>
                                            <input class="form-control" name="objective" value="{{ old('objective', $researchProject->objective) }}" placeholder="Project Objective">
                                            @error('objective')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 mb-24">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="datepicker" class="form-control fc-datepicker" name="timeline_from" value="{{ \Carbon\Carbon::parse($researchProject->timeline_from)->format('d-m-Y') }}" placeholder="DD-MM-YYYY" type="text">
                                            @error('timeline_from')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 mb-24">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="datepicker" class="form-control fc-datepicker" name="timeline_to" value="{{ \Carbon\Carbon::parse($researchProject->timeline_to)->format('d-m-Y') }}" placeholder="DD-MM-YYYY" type="text">
                                            @error('timeline_to')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group mb-24"> <label class="form-label">Description:</label>
                                    <textarea class="form-control" name="description" cols="30" rows="10">{{ old('description', $researchProject->description) }}</textarea>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="input-group file-browser">
                                                <label class="input-group-append mb-0"> <span class="btn ripple btn-light"> Browse
                                                    ...
                                                    @if ($researchProject->attachment)
                                                        <a href="{{ asset($researchProject->attachment) }}" target="_blank">View current attachment</a>
                                                    @endif
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="custom-controls-stacked d-lg-flex align-items-center">
                                            ...
                                            <label class="custom-control custom-radio success me-4">
                                                <input type="radio" class="custom-control-input" name="status" value="1"
                                                    {{ old('status', $researchProject->status) == 1 ? 'checked' : '' }}>
                                                <span class="custom-control-label">Pending</span>
                                            </label>

                                            <label class="custom-control custom-radio success me-4">
                                                <input type="radio" class="custom-control-input" name="status" value="2"
                                                    {{ old('status', $researchProject->status) == 2 ? 'checked' : '' }}>
                                                <span class="custom-control-label">On Progress</span>
                                            </label>

                                            <label class="custom-control custom-radio success me-4">
                                                <input type="radio" class="custom-control-input" name="status" value="3"
                                                    {{ old('status', $researchProject->status) == 3 ? 'checked' : '' }}>
