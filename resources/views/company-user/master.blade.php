...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="{{route('company-user.dashboard')}}" class="brand-logo">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{route('company-user.company.create')}}">Add Company</a></li>
                        <li><a href="{{route('company-user.company.index')}}">Manage Company</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
                        <span class="nav-text">Job Circular</span>

                    </a>
                    <ul aria-expanded="false">
                        <li><a href="{{route('company-user.job-circular.create')}}">Add Category</a></li>
                        <li><a href="{{route('company-user.job-circular.index')}}">Manage Category</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-regular fa-gear fw-bold"></i>
                        <span class="nav-text">Job Applicants</span>

                    </a>
                    <ul aria-expanded="false">
                        <li><a href="{{route('company-user.job-circular.applicants')}}">Applicants List</a></li>
                    </ul>
                </li>
