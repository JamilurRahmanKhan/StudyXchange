    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Add Job Circular</li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('company-user.job-circular.store') }}" method="POST" id="details-form" enctype="multipart/form-data">
                            @csrf
                            <div class="col-xl-8">
                                <div class="card h-auto">
                                    <div class="card-body">
                                        ...
                                        <div id="requirements-editor-container"></div>
                                        <input type="hidden" name="requirement"  id="requirements">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="salary_range" class="form-control" placeholder="Salary Range" value="{{ old('salary_range') }}">
                                            @error('salary_range')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="datePicker" name="application_deadline" class="form-control">
                                        </div>
